...
var userNameArray = ["Sania", "Hiba", "Laiba", "Neha", "Mirha"];
for (var i = 0; i < userNameArray.length; i++) {
    console.log("Is userNameArray == ".concat(userNameArray[i], "? I predict True."));
    console.log(userNameArray[i] == userNameArray[i]);
}
// this test will print five condition test that are false:
var userNameArray1 = ["Sania", "Hiba", "Laiba", "Neha", "Mirha"];
for (var i = 0; i < userNameArray1.length; i++) {
    console.log("Is userNameArray1 == ".concat(userNameArray1[i], "? I predict False."));
