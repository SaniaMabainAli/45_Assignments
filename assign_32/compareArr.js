...
var currentUsers = ["Sania", "Neha", "Sara", "Sana", "ZaRa"];
var newUsers = ["Saima", "SANA", "Atia", "SANIA", "zoha"];
...
newUsers.forEach(function (newUser) {
    if (currentUsers.some(function (currentUser) { return currentUser.toLowerCase() === newUser.toLowerCase(); })) {
        console.log("UserName ".concat(newUser, " is already taken. please enter new Username!"));
    }
    else {
